---
name: BidBox workbench manual build env vars
...
Manual `vite build` of `@workspace/bidbox-workbench` requires **both** env vars:

- `PORT=21921`
- `BASE_PATH=/`

Correct invocation: `PORT=21921 BASE_PATH=/ pnpm --filter @workspace/bidbox-workbench run build`
