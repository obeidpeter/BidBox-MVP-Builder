...
export interface EvidenceRenewalSnapshot {
  ...
  authorityNote: 'This register records a receipt-backed internal due reminder and named-human evidence-renewal workflow. It does not send an external message, contact an issuer or client, approve a pursuit, or claim delivery outside BidBox.';
}
...
export interface GrowthCreateQuoteDraft {
  ...
  currency: string;
  /**
     * Entered by a named operator; never calculated by BidBox.
     * @minimum 1
     * @maximum 1000000000000000
     */
  amountMinor: number;
 ...
 * It is valid only when `X-BidBox-Organisation-Id` names the session target,
